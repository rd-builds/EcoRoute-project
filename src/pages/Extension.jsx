  ...
  return (
    <div className="ext-page">
      <div className="ext-container">
        ...
        {/* Heading */}
        <h1 className="ext-heading">
          Use EcoRoute wherever you use AI.
        </h1>

        {/* Short Description */}
        <p className="ext-description">
          The EcoRoute browser extension helps you improve your prompts
          directly where you already use AI. Write your request normally,
          let EcoRoute optimize it, and insert the improved prompt into
          your AI tool.
        </p>
        ...
        <div className="ext-cta-wrap">
          ...
          <span className="ext-subtext">
            Available for supported Chromium browsers
          </span>
        </div>
            ...
            <div className="ext-browser-body">
              ...
              <div className="ext-mock-improved-preview">
                <div className="ext-mock-improved-text">
                  “Explain quantum computing principles with key milestones
                  and practical examples in simple terms.”
                </div>

                <span className="ext-mock-replace-badge">
                  1-Click Insert
                </span>
              </div>
